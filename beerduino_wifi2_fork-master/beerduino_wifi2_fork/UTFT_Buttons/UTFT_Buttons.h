...
#define MAX_BUTTONS	40	// Maximum number of buttons available at one time
...
class UTFT_Buttons
{
	...
	protected:
		...
		word		_color_text, _color_text_inactive, _color_background, _color_border, _color_hilite, _color_black;
